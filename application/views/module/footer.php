...
//         purchase_report();
//       } else if (document.location.href === base_url+'/admin/debt' || document.location.href === base_url+'/admin/debt#') {
//         debt();
//       } else if (document.location.href === base_url+'/admin/receivable' || document.location.href === base_url+'/admin/receivable#') {
//         receivable();
//       } else if (document.location.href === base_url+'/admin/capital' || document.location.href === base_url+'/admin/capital#') {
//         capital();
//       } 
//     }
...
//     // DEBT
//     const debt = () => {
//       $("#debt").on("show.bs.modal",
//         (e) => {
//           const ids = $(e.relatedTarget).data("ids");

//           $.ajax({
//             url: base_url+"/ajax/debt",
//             method: "get",
//             data: {
//               id: ids
//             },
...
//               arrsales = JSON.parse(res)
//               arrsales.forEach((item, index) => {
//                 $("#no_debt").number(no_debt);
//                 $("#debt_date").date(debt_date);
//                 $("#debit").number(debit);
//                 $("#credit").number(credit);
//                 $("#catatan_debt").text(catatan_debt);
//                 $("#nominal_debt").number(nominal_debt);
//               })
//             },
//             error: (err) => {
//               alert("error mendapatkan data!");
...
//     // RECEIVABLE
//     const receivable = () => {
//       $("#receivable").on("show.bs.modal",
//         (e) => {
//           const ids = $(e.relatedTarget).data("ids");

//           $.ajax({
//             url: base_url+"/ajax/receivable",
//             method: "get",
//             data: {
//               id: ids
//             },
...
//     // CAPITAL
//     const capital = () => {
//       $("#capital").on("show.bs.modal",
//         (e) => {
//           const ids = $(e.relatedTarget).data("ids");

//           $.ajax({
//             url: base_url+"/ajax/capital",
//             method: "get",
//             data: {
//               id: ids
//             },
