...
class Admin extends CI_Controller {
  ...
  public function debt() {
    $data['title'] = 'Admin | Hutang';
    $data['bc'] = 'Data Master / Hutang';
    $data['debt'] = $this->apotek_models->get_data('debt');
    $this->load->view('module/header', $data);
    $this->load->view('admin/debt', $data);
    $this->load->view('module/footer');
  }

  public function receivable() {
    $data['title'] = 'Admin | Piutang';
    $data['bc'] = 'Data Master / Piutang';
    $data['receivable'] = $this->apotek_models->get_data('receivable');
    $this->load->view('module/header', $data);
    $this->load->view('admin/receivable', $data);
    $this->load->view('module/footer');
  }

  public function capital() {
    $data['title'] = 'Admin | Modal';
    $data['bc'] = 'Data Master / Modal';
    $data['capital'] = $this->apotek_models->get_data('capital');
    $this->load->view('module/header', $data);
    $this->load->view('admin/capital', $data);
    $this->load->view('module/footer');
  }
  ...
  public function laporanlabarugi() {
    $data['title'] = 'Admin | Laporan Laba Rugi';
    $data['bc'] = 'Laporan / Laporan Laba Rugi';
    $this->load->view('module/header', $data);
    $this->load->view('admin/laporanlabarugi', $data);
    $this->load->view('module/footer');
  }
  ...
  public function add_debt() {
    $no_debt = $this->input->post("debt_no");
    $debt_date = $this->input->post("debt_date");
    $debit = $this->input->post("debit");
    $credit = $this->input->post("credit");
    $catatan_debt = $this->input->post("catatan_debt");
    $nominal_debt = $this->input->post("nominal_debt");
    ...
    $arr = [
      ...
      "debit" => $debit,
      "credit" => $debit,
      "catatan_debt" => $catatan_debt,
      "nominal_debt" => $nominal_debt
    ];

    $this->db->insert("debt", $arr);
    $this->session->set_flashdata("msg", "<div class='alert alert-success'>Hutang baru dengan nomor ". $no_debt. " dan xatatan ". $catatan. " ditambahkan</div>");
    redirect("admin/debt");
  }
  ...
  public function addreceivable() {
    ...
    $this->db->insert("receivable", $arr);
    $this->session->set_flashdata("msg", "<div class='alert alert-success'>Piutang baru dengan nomor ". $no_re. " dan catatan ". $catatan. " ditambahkan</div>");
    redirect("admin/receivable");
  }

  public function addcapital() {
    $no_cap = $this->input->post("no_cap");
    ...
    $this->db->insert("capital", $arr);
    $this->session->set_flashdata("msg", "<div class='alert alert-success'>Modal baru dengan nomor ". $no_cap. " dan catatan ". $catatan. " ditambahkan</div>");
  ...
  public function editreceivable() {
    ...
    $this->db->where("no", $no_re);
    $this->db->update("receivable", [
      "re_date" => $re_date,
      "debit" => $debit,
      "credit" => $credit,
      "catatan" => $catatan,
  ...
  public function editcapital() {
    ...
    $this->db->where("no", $no_cap);
    $this->db->update("capital", [
      "date" => date,
      "debit" => $debit,
      "credit" => $credit,
      "catatan" => $catatan,
  ...
  public function deletedebt($id) {
    ...
    $this->session->set_flashdata("msg", "<div class='alert alert-success'>Data hutang berhasil dihapus!</div>");
    redirect("admin/debt");
  }

  public function deletereceivable($id) {
    $this->db->delete("receivable", ["id" => $id]);
    $this->session->set_flashdata("msg", "<div class='alert alert-success'>Data Piutang berhasil dihapus!</div>");
    redirect("admin/receivable");
  }

  public function deletecapital($id) {
    $this->db->delete("capital", ["id" => $id]);
    $this->session->set_flashdata("msg", "<div class='alert alert-success'>Data Modal berhasil dihapus!</div>");
    redirect("admin/capital");
  }
  ...
  public function printdebt(){
    ...
    $this->load->view("module/header", $data);
    $this->load->view("admin/prints/debt", $data);
  }

  public function printreceivable(){
    $tglmulai = $this->input->get("tglmulai");
    $tglhingga = $this->input->get("tglhingga");
    
    $data['title'] = "Laporan data piutang";
    $data['receivable'] = $this->apotek_models->get_data('receivable');
    ...
    $this->load->view("module/header", $data);
    $this->load->view("admin/prints/receivable", $data);
  }

  public function printcapital(){
    $tglmulai = $this->input->get("tglmulai");
    $tglhingga = $this->input->get("tglhingga");
    
    $data['title'] = "Laporan data modal";
    $data['capital'] = $this->apotek_models->get_data('capital');
    ...
    $this->load->view("module/header", $data);
    $this->load->view("admin/prints/capital", $data);
  }
